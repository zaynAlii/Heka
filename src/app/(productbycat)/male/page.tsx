...
type tFemalearray = {
 ...
 const page = () => {
    ...
    maleArray = ProductData().filter((obj) => obj.cat === "male")
    return (
        <div className='flex  flex-wrap mx-20 justify-evenly  mt-14  my-20'>

            {
                maleArray.map((obj, i) => {
                    ...
                    return (
                        <div key={i+"q"} className='   hover:scale-110 transition-all ease-out duration-300 hover:border-l-2 border-cyan-400 hover:border-b-2'>
